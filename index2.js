...
client.login("NTE4NzgwMTAyMDMzNTM5MDcy.DuahKA.o1HAkBRiE4dnc8gECtue14dgGI0");
...
bot.on("guildMemberRemove", member => {
  member.guild.channeles.find("name", "📡-bienvenue-aurevoir").send('${member} viens de quitter le serveur ')
})

bot.on('guildMemberAdd', member => {
  var role = member.guild.roles.find('name', '🎮| Joueur(s)');
  member.addRole(role)
...
client.on('message', async message => { 
    ...
    if(message.content === prefix + "fun") {
      ...
      .addField("/8ball", "Le bot répond à votre question !")
